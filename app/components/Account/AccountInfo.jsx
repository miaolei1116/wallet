    ...
    render() {
        ...
        return (
            <div className={"account-info" + (this.props.my_account ? " my-account" : "")}>
                ...
                <AccountImage image={img.logo} account={account.get("name")} custom_image={null}/>
                <p style={{fontSize:"1.4rem",fontWight:"blod",color:"#eee"}}>Bizchain</p>
