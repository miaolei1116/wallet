...
import {ChainTypes as grapheneChainTypes} from "gxbjs/es";
...
class RecentTransactions extends React.Component {
    ...
    render() {
        ...
        if (true || this.props.showFilters) {
            ...
            options = ["all", "transfer", "account_create", "account_update", "asset_create",
                "witness_withdraw_pay", "vesting_balance_withdraw"]
            .map(type => {
            ...
            <div className="recent-transactions no-overflow" style={style}>
                <div className="generic-bordered-box">
                    <div ref="header">
                        ...
                        <div className="block-content-header" style={{marginBottom:"2rem"}}>
                            <span style={{marginRight:"2rem"}}>{this.props.title ? this.props.title : <Translate content="account.recent" />}</span>

                            {historyCount > 0 ?
                            <span style={{fontSize: "60%", textTransform: "lowercase"}}>
                                &nbsp;
                                <a
                                    className="inline-block info button"
                        ...
                        <table className={"table" + (compactView ? " compact" : "")}>
                            <thead>
                                <tr style={{backgroundColor:"rgba(68,76,100,.8)"}}>
                                    {compactView ? null : <th className="column-hide-tiny" style={{width: "30%",color:"#FFF"}}><Translate content="explorer.block.op" /></th>}
                                    <th style={{color:"#FFF"}}><Translate content="account.votes.info" /></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
