...
class Settings extends React.Component {
    ...
    constructor(props) {
        ...
        // console.log(props)
        this.state = {
            judgeDraw:hashHistory.getCurrentLocation().pathname,
            ...
            settingEntries: {
                general: ["walletLockTimeout"],
                // general: [ "locale","walletLockTimeout", "themes", "reset"],
    ...
    componentWillMount() {
        if(this.state.judgeDraw === "/walletControl"){
           this.setState({menuEntries: []});
           this.setState({menuEntries: ["wallet","backup"]});
        }
    ...
    render() {
        // console.log(this.state.menuEntries)
        // console.log(this.state.judgeDraw)
        ...
        return (
            ...
            <div className="grid-content">
                <div className="grid-container main-content medium-10 " style={{marginTop: "1rem"}}>
                    ...
                    <ul className="vertical medium-horizontal menu-bar medium-6" style={{marginBottom:"3rem"}}>
                        {menuEntries.map((entry, index) => {
                            return <li className={index === activeSetting ? "active" : ""} onClick={this._onChangeMenu.bind(this, entry)} key={entry}><a><Translate content={"settings." + entry} /></a></li>;
                        })}
                    </ul>
