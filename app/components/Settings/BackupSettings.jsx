...
import { LastBackupDate } from "../Wallet/Backup"
...
export default class BackupSettings extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <div className="grid-block" style={{marginLeft:"1rem",marginBottom:"2rem"}}>
                    <div className="grid-block medium-3" style={{paddingTop:"0.6rem"}}>
                        创建备份:
                    </div>
