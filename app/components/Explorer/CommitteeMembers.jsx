    ...
    render() {
        ...
        return (
            <tr>
                ...
                <td onClick={this._onRowClick.bind(this)}>{committee_member_data.get('total_votes')}<span style={{paddingLeft:"1rem",color:"#aaa"}}> BZC</span></td>
...
class CommitteeMemberList extends React.Component {
    ...
    render() {
        ...
        if (!cardView) {
            return (
                <table className="medium-12 table table-hover" >
                    <thead className="medium-12" style={{broder:0,backgroundColor:"rgba(68,76,100,1)"}}>
                        <tr>
                            <th style={{color:"#fff",width:"30%"}} className="clickable" onClick={this._setSort.bind(this, 'rank')}><Translate content="explorer.witnesses.rank" /></th>
                            <th style={{color:"#fff",width:"30%"}} className="clickable" onClick={this._setSort.bind(this, 'name')}><Translate content="account.votes.name" /></th>
                            <th style={{color:"#fff",width:"40%"}} className="clickable" onClick={this._setSort.bind(this, 'total_votes')}><Translate content="account.votes.votes" /></th>
        ...
        return (
            <div className="grid-block">
                <div className="grid-block page-layout vertical">
                    <div className="grid-block" style={{marginBottom:"0.5rem"}}>
                        <div className="grid-block align-center">
                            <h3><Translate content="explorer.committee_members.active" />: {Object.keys(globalObject.active_committee_members).length}</h3>
                    ...
                    <div className="grid-content vertical">
                            <div className="grid-container align-center medium-6">
                                {/*<Translate component="h3" content="markets.filter" />*/}
                                <input placeholder="搜索账户名" type="text" value={this.state.filterCommitteeMember} onChange={this._onFilter.bind(this)} />
                            </div>
                            <div className="grid-container medium-10">
                                <CommitteeMemberList
