        ...
        let uia = assets.filter(a => {
            ...
            return (
                <tr key={asset.symbol}>
                    ...
                    <td><FormattedAsset amount={asset.dynamic_data.current_supply} asset={asset.id} hide_asset={true}/>
                    </td>
            ...
            <div className="grid-block vertical">
                <div className="grid-block page-layout">
                    <div className="grid-block small-12 medium-10 medium-offset-1 main-content vertical">
                        <div className="generic-bordered-box" style={{paddingTop: 25,textAlign:"center"}}>
                            {/*<Tabs
                            ...
                            <Translate component="h4" content="explorer.assets.user"/>
                            <div className="grid-block shrink align-center" style={{paddingTop:"2rem"}}>
                                <input style={{maxWidth: "500px"}} placeholder={placeholder} type="text"
                                       value={this.state.filterUIA}
                                       onChange={this._onFilter.bind(this, "filterUIA")}></input>
                            </div>
                            <div className="grid-block" style={{paddingBottom: 20}}>
                                <table className="table">
                                    <thead style={{border:0,backgroundColor:"rgba(68,76,100,1)"}}>
                                    <tr>
                                        <th style={{color:"#FFF",textAlign:"center"}}><Translate component="span" content="explorer.assets.symbol"/></th>
                                        <th style={{color:"#FFF",textAlign:"center"}}><Translate component="span" content="explorer.assets.issuer"/></th>
                                        <th style={{color:"#FFF",textAlign:"center"}}><Translate component="span" content="markets.supply"/></th>
                                    </tr>
                                    </thead>
