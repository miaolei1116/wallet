        ...
        if (!cardView) {
            return (
                <table className="table table-hover">
                    <thead style={{border:0,backgroundColor:"rgba(68,76,100,1)"}}>
                        <tr>
                            <th style={{color:"#FFF"}} className="clickable" onClick={this._setSort.bind(this, 'rank')}><Translate content="explorer.witnesses.rank" /></th>
                            <th style={{color:"#FFF"}} className="clickable" onClick={this._setSort.bind(this, 'name')}><Translate content="account.votes.name" /></th>
                            <th style={{color:"#FFF"}} className="clickable" onClick={this._setSort.bind(this, 'last_aslot')}><Translate content="explorer.blocks.last_block" /></th>
                            <th style={{color:"#FFF"}} className="clickable" onClick={this._setSort.bind(this, 'last_confirmed_block_num')}><Translate content="explorer.witnesses.last_confirmed" /></th>
                            <th style={{color:"#FFF"}} className="clickable" onClick={this._setSort.bind(this, 'total_missed')}><Translate content="explorer.witnesses.missed" /></th>
                            <th style={{color:"#FFF"}} className="clickable" onClick={this._setSort.bind(this, 'total_votes')}><Translate content="account.votes.votes" /></th>
                        </tr>
                    </thead>
                <tbody>
                    {itemRows}
                ...
                <div className="grid-block page-layout vertical">
                    <div className="">
                        <div className="grid-content">
                            <br/>
                            <h2 style={{textAlign:"center"}}>当前数据</h2>
                            <table className="grid-block">
                                <tbody className="grid-block medium-12 witnesses-data" style={{padding:"1rem 1rem 2rem 3rem"}}>
                                    <tr className="grid-content medium-1" style={{}}>
                                        <td><Translate content="explorer.witnesses.current"/></td>
                                        <td>{currentAccount ? currentAccount.get("name") : null}</td>
                                    </tr>
                                    <tr className="grid-content medium-1">
                                    ...
                                    <tr className="grid-content medium-1" style={{marginRight:0}}>
                           ...
                           {/* <div className="filter">
                                <label><Translate content="markets.filter" /></label>
