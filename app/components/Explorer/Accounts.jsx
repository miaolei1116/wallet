        ...
        return (
            <div className="grid-block page-layout">
                <div className="grid-block vertical medium-6 medium-offset-3">
                    <div className="grid-content shrink" style={{textAlign:"center"}}>
                        <Translate component="h3" content="explorer.accounts.title" />
                        <input placeholder="搜索账户名" type="text" value={this.state.searchTerm} onChange={this._onSearchChange.bind(this)}/>
                    </div>
                    <div className="grid-content">
                        <table className="table">
                            <thead style={{border:0,backgroundColor:"rgba(68,76,100,1)"}}>
                                <tr>
                                    <th style={{color:"#FFF",textAlign:"center"}}><Translate component="span" content="explorer.assets.id" /></th>
                                    <th style={{color:"#FFF",textAlign:"center"}}><Translate component="span" content="account.name" /></th>
                                    <th style={{color:"#FFF",textAlign:"center"}}><Translate component="span" content="gateway.balance" /></th>
                                    <th style={{color:"#FFF",textAlign:"center"}}><Translate component="span" content="account.percent" /></th>
                                </tr>
                            </thead>
