        ...
        return (
            <div ref="outerWrapper" className="grid-block vertical page-layout">
                ...
                <div className="align-center grid-block shrink small-horizontal blocks-row">
                    <div className="grid-block text-center small-6 medium-2 blockStyle greenStyle">
                    ...
                    <div className="grid-block text-center small-6 medium-2 blockStyle greenStyle">
                        <div className="grid-content">
                            ...
                            <h2><BlockTimeAgo blockTime={headBlock} /></h2>
                        </div>
                    </div>
                    <div className="grid-block text-center small-6 medium-2 blockStyle greenStyle">
                        <div className="grid-content">
                ...
                { /* Second row of stats */ }
                <div  className="align-center grid-block shrink small-horizontal  blocks-row">
                    <div className="grid-block text-center small-6 medium-2 blockStyle">
                ...
                <div className="align-center grid-block shrink small-horizontal blocks-row">
                    ...
                    {/*<div className="grid-block text-center small-12 medium-3">
                        <div className="grid-content no-overflow">
                            <div className="text-left txtlabel">
                                <Translate component="span" content="explorer.blocks.block_times" />
                            </div>
                    ...
                    <div className="grid-block text-center small-12 medium-2 blockStyle" style={{opacity:0}}></div>
                    <div className="grid-block text-center small-12 medium-2 blockStyle" style={{opacity:0}}></div>
                </div>

            { /* Fourth row: transactions and blocks */ }
                <div ref ="transactionsBlock" className="grid-block" style={{padding:"0rem 7rem"}}>

                    <div className="grid-block medium-12 show-for-medium vertical" style={{paddingBottom: 0,opacity:1,zIndex:10}}>
                        <div className="grid-block vertical generic-bordered-box">
                                <div ref="blocksText" >
                    ...
                    <div className="grid-block small-12 medium-0 vertical" style={{paddingBottom: 0,opacity:0}}>
                        <div className="grid-block vertical generic-bordered-box">
