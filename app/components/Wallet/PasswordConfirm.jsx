    ...
    render() {
        ...
        return (
            ...
            >
                    ...
                    <div className="grid-block" style={{marginLeft:"1rem",lineHeight:"2rem",marginBottom:"3rem"}}>
                        <div className="grid-block medium-3">新密码 :</div>
                    ...
                    <div className="grid-block" style={{marginLeft:"1rem",lineHeight:"2rem",marginBottom:"3rem"}}>
                        ...
                        <div className="grid-block medium-3">重复密码</div>
                        <div className="grid-block medium-6">
                            <section>
                            <input
                                type="password"
