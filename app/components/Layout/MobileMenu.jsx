...
class MobileMenu extends React.Component {
    ...
    render() {
        ...
        let linkToAccountOrDashboard= <a onClick={this._onNavigate.bind(this, "/dashboard")}><Translate content="header.dashboard" /></a>;
        if (linkedAccounts.size === 0) linkToAccountOrDashboard = <Link to="/create-account">Create Account</Link>;

        // let tradeLink = <a onClick={this._onNavigate.bind(this, `/data-market`)}><Translate content="header.data_market" /></a> ;
              ...
              <div className="grid-content" style={{zIndex: 200}}>
                ...
                <section style={{marginTop: "3rem"}} className="block-list">
                    <ul>
                        ...
                        {/*currentAccount && myAccounts.indexOf(currentAccount) !== -1 ? <li onClick={this.onClick}><Link to={`/account/${currentAccount}/deposit-withdraw/`}><Translate content="account.deposit_withdraw"/></Link></li> : null*/}
